    ...
    <header className="signin">
      <div>
        ...
        <div className="signin">
          <button onClick={() => Auth.signIn(workerNames['worker1'], worker['worker1Password'])}>Sign in as {workerNames['worker1']}</button>
          <button onClick={() => Auth.signIn(workerNames['worker2'], worker['worker2Password'])}>Sign in as {workerNames['worker2']}</button>
        </div>
      </div>
    </header>
  ) : (
